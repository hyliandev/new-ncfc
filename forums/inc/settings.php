...
$settings['adminemail'] = "[no address given]";
...
$settings['bbname'] = "Nintendo Community Fangame Convention FOrums";
$settings['bburl'] = "http://php56.example.com/ncfc/forums";
$settings['canviewownwarning'] = "1";
$settings['captchaimage'] = "1";
$settings['bbcodeinserter'] = "1";
$settings['smilieinserter'] = "1";
$settings['faxno'] = "";
$settings['contactlink'] = "mailto:[no address given]";
$settings['cplanguage'] = "english";
$settings['cpstyle'] = "";
$settings['cookiedomain'] = ".php56.example.com";
$settings['cookiepath'] = "/ncfc/";
...
$settings['homename'] = "Nintendo Community Fangame Convention";
$settings['homeurl'] = "/ncfc/mainsite/";
