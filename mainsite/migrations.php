...
$event = new Event();
$event->Set('start_date', strtotime('2018-11-1'));
$event->Set('end_date', strtotime('2018-11-9'));
$event->Set('title', 'Fake 2018 NCFC');
$event->Save();

/**/

$m = file_get_contents('./mainsite/Migrations');
$m = explode("", $m);
$m[1] = "\n\n\n\n";
$m = implode($m);

file_put_contents('./mainsite/Migrations', $m);
